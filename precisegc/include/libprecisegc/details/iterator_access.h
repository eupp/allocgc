...
{
public:
    static bool equal(const Iterator& it1, const Iterator& it2)
    {
        return it1.equal(it2);
    }

    template <typename U = typename Iterator::iterator_category>
    static auto less_than(const Iterator& it1, const Iterator& it2)
    ...
    template <typename U = typename Iterator::iterator_category>
    static auto decrement(Iterator* it)
    ...
    template <typename U = typename Iterator::iterator_category>
    static auto advance(Iterator* it, size_t n)
    ...
    template <typename U = typename Iterator::iterator_category>
    static auto difference(const Iterator& it1, const Iterator& it2)
