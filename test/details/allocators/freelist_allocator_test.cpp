...
class freelist_allocator_test : public ::testing::Test
{
public:
    typedef debug_layer<default_allocator> allocator_t;
    typedef freelist_allocator<test_descriptor, allocator_t, utils::dummy_mutex> freelist_allocator_t;

    freelist_allocator_t alloc;
};

TEST_F(freelist_allocator_test, test_allocate)
{
...
TEST_F(freelist_allocator_test, test_deallocate)
{
...
TEST_F(freelist_allocator_test, test_range)
{
